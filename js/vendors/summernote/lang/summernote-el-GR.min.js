  ...
  return (
    (e = require('jquery')).extend(e.summernote.lang, {
      'el-GR': {
        ...
        options: { help: 'Βοήθεια', fullscreen: 'Πλήρης οθόνη', codeview: 'Προβολή HTML' },
        paragraph: {
        ...
        specialChar: { specialChar: 'ΕΙΔΙΚΟΙ ΧΑΡΑΚΤΗΡΕΣ', select: 'Επιλέξτε ειδικούς χαρακτήρες' },
        output: { noSelection: 'Δεν έγινε επιλογή!' },
      },
    }),
    {}
  )
