  ...
  return (
    (e = require('jquery')).extend(e.summernote.lang, {
      'uz-UZ': {
        ...
        table: { table: 'Жадвал' },
        hr: { insert: 'Горизонтал чизиқни қўйиш' },
        style: {
          style: 'Услуб',
          p: 'Яхши',
          blockquote: 'Жумла',
        ...
        lists: { unordered: 'Белгиланган рўйҳат', ordered: 'Рақамланган рўйҳат' },
        options: { help: 'Ёрдам', fullscreen: 'Бутун экран бўйича', codeview: 'Бошланғич код' },
        paragraph: {
          paragraph: 'Параграф',
        ...
        history: { undo: 'Бекор қилиш', redo: 'Қайтариш' },
      },
    }),
    {}
  )
