...
!(function (e, i) {
  if ('object' == typeof exports && 'object' == typeof module) module.exports = i()
    ...
    var a = i()
    for (var t in a) ('object' == typeof exports ? exports : e)[t] = a[t]
  }
})(self, function () {
  return (
    (e = require('jquery')).extend(e.summernote.lang, {
      'fi-FI': {
        ...
        lists: { unordered: 'Luettelomerkitty luettelo', ordered: 'Numeroitu luettelo' },
        options: { help: 'Ohje', fullscreen: 'Koko näyttö', codeview: 'HTML-näkymä' },
        paragraph: {
          paragraph: 'Kappale',
        ...
        specialChar: { specialChar: 'ERIKOISMERKIT', select: 'Valitse erikoismerkit' },
      },
    }),
    {}
  )
