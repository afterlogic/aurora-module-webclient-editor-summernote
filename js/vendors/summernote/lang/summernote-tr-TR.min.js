...
!(function (a, i) {
  if ('object' == typeof exports && 'object' == typeof module) module.exports = i()
    ...
    var e = i()
    for (var r in e) ('object' == typeof exports ? exports : a)[r] = e[r]
  }
})(self, function () {
  return (
    (a = require('jquery')).extend(a.summernote.lang, {
      'tr-TR': {
        ...
        options: { help: 'Yardım', fullscreen: 'Tam ekran', codeview: 'HTML Kodu' },
        paragraph: {
          paragraph: 'Paragraf',
        ...
        specialChar: { specialChar: 'ÖZEL KARAKTERLER', select: 'Özel Karakterleri seçin' },
      },
    }),
    {}
  )
