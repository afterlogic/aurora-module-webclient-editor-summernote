...
!(function (t, a) {
  ...
  return (
    (t = require('jquery')).extend(t.summernote.lang, {
      'cs-CZ': {
        font: {
          bold: 'Tučné',
          italic: 'Kurzíva',
        ...
        options: { help: 'Nápověda', fullscreen: 'Celá obrazovka', codeview: 'HTML kód' },
        paragraph: {
          paragraph: 'Odstavec',
        ...
        specialChar: { specialChar: 'SPECIÁLNÍ ZNAKY', select: 'Vyberte speciální znaky' },
      },
    }),
    {}
  )
