  ...
  return (
    (e = require('jquery')).extend(e.summernote.lang, {
      'ca-ES': {
        ...
        options: { help: 'Ajut', fullscreen: 'Pantalla sencera', codeview: 'Veure codi font' },
        paragraph: {
          paragraph: 'Paràgraf',
        ...
        specialChar: { specialChar: 'CARÀCTERS ESPECIALS', select: 'Selecciona caràcters especials' },
      },
    }),
    {}
  )
