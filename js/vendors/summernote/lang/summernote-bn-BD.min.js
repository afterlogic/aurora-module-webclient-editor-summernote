  ...
  return (
    (e = require('jquery')).extend(e.summernote.lang, {
      'bn-BD': {
        ...
        hr: { insert: 'বিভাজক রেখা সন্নিবেশ করুন' },
        style: {
          style: 'শৈলী',
          p: 'সাধারণ',
          blockquote: 'উক্তি',
        ...
        lists: { unordered: 'অবিন্যস্ত তালিকা', ordered: 'বিন্যস্ত তালিকা' },
        options: { help: 'সাহায্য', fullscreen: 'পূর্ণ পর্দা', codeview: 'কোড দৃশ্য' },
        paragraph: {
          paragraph: 'অনুচ্ছেদ',
        ...
        history: { undo: 'পূর্বাবস্থায় আনুন', redo: 'পুনঃকরুন' },
        specialChar: { specialChar: 'বিশেষ অক্ষর', select: 'বিশেষ অক্ষর নির্বাচন করুন' },
      },
    }),
    {}
  )
