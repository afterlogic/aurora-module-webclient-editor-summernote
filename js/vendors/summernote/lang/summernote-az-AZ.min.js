...
!(function (a, i) {
  if ('object' == typeof exports && 'object' == typeof module) module.exports = i()
    ...
    var r = i()
    for (var l in r) ('object' == typeof exports ? exports : a)[l] = r[l]
  }
})(self, function () {
  return (
    (a = require('jquery')).extend(a.summernote.lang, {
      'az-AZ': {
        font: {
          bold: 'Qalın',
          italic: 'Əyri',
        ...
        lists: { unordered: 'Nizamsız sıra', ordered: 'Nizamlı sıra' },
        options: { help: 'Kömək', fullscreen: 'Tam ekran', codeview: 'HTML Kodu' },
        paragraph: {
          paragraph: 'Paraqraf',
        ...
        history: { undo: 'Əvvəlki vəziyyət', redo: 'Sonrakı vəziyyət' },
