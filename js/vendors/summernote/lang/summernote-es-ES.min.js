...
!(function (e, a) {
  ...
  return (
    (e = require('jquery')).extend(e.summernote.lang, {
      'es-ES': {
        font: {
          bold: 'Negrita',
          italic: 'Cursiva',
        ...
        hr: { insert: 'Insertar una línea horizontal' },
        style: {
          style: 'Estilo',
          p: 'Normal',
          blockquote: 'Cita',
        ...
        lists: { unordered: 'Lista', ordered: 'Lista numerada' },
        options: { help: 'Ayuda', fullscreen: 'Pantalla completa', codeview: 'Ver el código fuente' },
        paragraph: {
          paragraph: 'Párrafo',
        ...
        specialChar: { specialChar: 'CARACTERES ESPECIALES', select: 'Seleccionar caracteres especiales' },
        output: { noSelection: '¡No ha seleccionado nada!' },
      },
    }),
    {}
  )
