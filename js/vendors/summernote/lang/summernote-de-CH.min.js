  ...
  return (
    (e = require('jquery')).extend(e.summernote.lang, {
      'de-CH': {
        ...
        hr: { insert: 'Horizontale Linie einfügen' },
        style: {
          style: 'Stil',
          normal: 'Normal',
          p: 'Normal',
        ...
        options: { help: 'Hilfe', fullscreen: 'Vollbild', codeview: 'Quellcode anzeigen' },
        paragraph: {
          paragraph: 'Absatz',
        ...
        specialChar: { specialChar: 'Sonderzeichen', select: 'Zeichen auswählen' },
      },
    }),
    {}
  )
