  ...
  return (
    (e = require('jquery')).extend(e.summernote.lang, {
      'gl-ES': {
        ...
        options: { help: 'Axuda', fullscreen: 'Pantalla completa', codeview: 'Ver código fonte' },
        paragraph: {
          paragraph: 'Parágrafo',
        ...
        specialChar: { specialChar: 'CARACTERES ESPECIAIS', select: 'Selecciona Caracteres especiais' },
      },
    }),
    {}
  )
